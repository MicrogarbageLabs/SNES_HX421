<#
  ...
  Produces snes\build\h6_probe.sfc. Same OBC1 header -> selects fpga_obc1.bi3.
...
Step "carttype 25 -> selects /sd2snes/fpga_obc1.bi3 (the 6b core)"
Write-Host ""
Write-Host "Flash the 6b fpga_obc1.bi3, then run h6_probe.sfc." -ForegroundColor Green
